...
class SignupForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            ['username', 'required'],
            ['username', 'unique', 'targetClass' => '\mirage\user\models\User', 'message' => 'This username has already been taken.'],
            ...
            ['email', 'unique', 'targetClass' => '\mirage\user\models\User', 'message' => 'This email address has already been taken.'],
